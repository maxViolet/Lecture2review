...
public class NewsItemList {
    ...
    public static NewsItem getNewsItemById(int id){
        ...
        for (NewsItem temp_item : news) {
            if (temp_item.getItemId() == id)
                return temp_item;
        }
        return null;
    }
...
//        задержка в отображении (по заданию)
//        try {
//            Thread.sleep(7000);
...
//        }
        ...
        Log.d("generateNews()", "in generating news: " + Thread.currentThread().getName() );
